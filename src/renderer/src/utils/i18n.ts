...
const ru: Record<string, string> = {
  ...
  'sort.by.manual': 'Вручную',
  'loading': 'Загрузка...',
  'no.notes': 'Нет заметок',
  'vault.missing': 'Папка заметок не найдена.\nСоздайте папку ~/Documents/jazz-notes-vault или запустите сервер с переменной JAZZ_VAULT, затем нажмите «Обновить».',
  'vault.retry': 'Обновить',
  'no.results': 'Ничего не найдено',
  'searching': 'Поиск...',
  'new.note': 'Новая заметка',
  'new.note.placeholder': 'Новая заметка...',
  'create.note': 'Создать',
  'create.batch.hint': 'Ctrl+Enter — создать ещё одну',
  'note.folder': 'Папка',
  'root': 'Корень',
  'create': '+',
  ...
  'language': 'Язык',
  'font': 'Шрифт',
  'ui.zoom': 'Масштаб интерфейса',
  'ui.zoom.reset': 'Сбросить',
  'no.color': 'Нет цвета',
  'date': 'Дата',
  'exit.confirm': 'Выйти?',
  ...
  'timer.hours': '2 часа',
  'timer.hour.one': '{n} час',
  'timer.hour.few': '{n} часа',
  'timer.hour.many': '{n} часов',
  'timer.day.one': '{n} день',
  'timer.day.few': '{n} дня',
  'timer.day.many': '{n} дней',
...
const en: Record<string, string> = {
  ...
  'sort.by.manual': 'Manual',
  'loading': 'Loading...',
  'no.notes': 'No notes',
  'vault.missing': 'Notes folder not found.\nCreate ~/Documents/jazz-notes-vault or start the server with JAZZ_VAULT, then click "Retry".',
  'vault.retry': 'Retry',
  ...
  'create.note': 'Create',
  'create.batch.hint': 'Ctrl+Enter — create another',
  'note.folder': 'Folder',
  'root': 'Root',
  'create': '+',
  ...
  'timer.hours': '2 hours',
  'timer.hour.one': '{n} hour',
  'timer.hour.few': '{n} hours',
  'timer.hour.many': '{n} hours',
  'timer.day.one': '{n} day',
  'timer.day.few': '{n} days',
  'timer.day.many': '{n} days',
